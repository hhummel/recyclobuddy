...
var updateText = document.addEventListener('submit', function(){
  ...
  var elLoader = document.getElementsByClassName('hidden').item(0);
  ...
  var intro = ["Getting your zone info may take a minute...",
