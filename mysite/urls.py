...
urlpatterns = [
    ...
    #Login in page
    url(r'^app/login$', auth_views.login, name='django.contrib.auth.views.login'),

    url(r'^success/$', app_views.success, name='success'),

    #Logout
    url(r'^app/logout/$', auth_views.logout, {'next_page': '../index'}, name='django.contrib.auth.views.logout'),
