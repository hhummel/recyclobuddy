...
def refresh_subscriber(dict_cur):
    dict_cur.execute("set autocommit = 1")
...
def refresh_messages(dict_cur):
    ...
    query = '''select prefix, first_name, middle_name, last_name, suffix, address, address2, city, state, zip, s1.municipality, email, mobile, carrier, 
